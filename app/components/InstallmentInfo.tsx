        ...
        <div className="bg-black text-white p-8 md:p-12 rounded-3xl shadow-2xl">
          ...
          <div className="border-t border-gray-600 pt-6 mt-6 text-center">
            <p className="text-lg mb-4">
              <span className="font-bold bg-primary-yellow text-black px-3 py-1 rounded">신용카드 현금화 무이자 할부를 활용</span><br/>
              <span className="mt-2 inline-block">하시면 경제적 부담을 줄일 수 있습니다.</span>
            </p>
